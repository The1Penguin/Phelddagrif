{
  description = "Phelddagrif goes flakes";
    ...
    let
      ...
      out = system:
        ...
        in
        {
          packages = rec {
            default = phelddagrif;
            phelddagrif = pkgs.haskell.packages.${ghcVer}.phelddagrif;
          };

          checks = {
            inherit (self.packages.${system}) phelddagrif;
          };
          ...
          devShells.default =
            ...
            haskellPackages.shellFor {
              packages = p: [ self.packages.${system}.phelddagrif ];
              withHoogle = true;
              buildInputs =
                (with pkgs; [
                  zlib
